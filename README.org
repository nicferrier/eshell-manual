...
* Licensing
I will submit this to be included in Emacs as a patch to the official manual, so I will assign copyright on it (the Texinfo file) to the [[https://www.fsf.org/][FSF]].  If you wish to make any contributions to this effort, you will have to do the same.
